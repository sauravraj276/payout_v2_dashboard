...
import triangle_icon from "./assets/icons/triangle.svg"
...
export default function Table() {
  ...
  return (
    <div className={styles.table_section}>
      <div className={styles.first_table_section}>
      ...
      <table className={styles.table}>
        <tr>
          <th>Order Id</th>
          <th>Order date <img src={triangle_icon}></img></th>
          <th>Order amount</th>
          <th>Transaction fees <img src={info_icon}
          title="Transaction fees are charged as a percentage of the order amount according to your plan."
          ></img></th>
        </tr>
        {generateTableRows()}
      </table>
